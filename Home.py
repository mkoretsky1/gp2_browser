...
# Configure the page - this must be the FIRST Streamlit command, and only called once.
st.set_page_config(
    page_title="Home",
...
class HomePage:
    ...
    def display(self):
        ...
        sent2.markdown(
            "<h5 style='text-align: center; '>Interactive tool to visualize quality control and ancestry prediction summary statistics\
            across all GP2 cohorts. Please select a page marked with \U0001F9EC in the sidebar to begin.</h5>",
            unsafe_allow_html=True,
        )
        ...
        with overview:
            ...
            st.markdown(
                "For a more in-depth description of the methods used to process the GP2 releases, please see the GenoTools preprint: \
            ...
            st.markdown(
                "The reference panel samples were split into an 80/20 train/test set and then PCs were fit to and transformed the training\
            ...
            st.markdown(
                "Scaled PCs for genotypes are transformed using UMAP trained fitted by the training set and then predicted by the classifier. \
            ...
            st.markdown(
                "Certain highly admixed ancestry groups are not well-represented by the constructed reference panel used by GenoTools. Due a lack of publicly available \
            ...
            st.caption(
                "_D.H. Alexander, J. Novembre, and K. Lange. Fast model-based estimation of ancestry in unrelated individuals. Genome Research, 19:1655–1664, 2009._"
            )
