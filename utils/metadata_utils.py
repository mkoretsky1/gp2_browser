...
def plot_age_distribution(master_key, plot1, plot2):
    """Create age distribution plots with optional stratification."""
    ...
    if stratify == 'None':
        ...
        fig = px.histogram(master_key_age, x='Age', color='Sex', nbins=25, 
        ...
        fig = px.histogram(master_key_age, x='Age', color='Phenotype', nbins=25, 
                           color_discrete_map={
                               'Control':"#332288", 'PD':"#CC6677", 
                               'Other':"#117733", 'Not Reported':"#D55E00"
                           })
...
def display_phenotype_counts(master_key, plot1):
    """Display phenotype counts split by sex."""
