...
def main():
    ...
    with right_col1:
        if not related_df.empty:
            ...
            related_df.rename(columns = {'label': 'Ancestry Category',
            ...
            st.dataframe(related_df[['Related Sample Count', 'Duplicated Sample Count']], use_container_width = True, height = 423)
